const projects = [
  { title: "Allocation Job Card", type: "Driver experience", image: "/project-covers/allocation-job-card.png", className: "project-allocation" },
  { title: "Dax Design Library", type: "Design system", image: "/project-covers/dax-design-library.png", className: "project-dax" },
  { title: "Pickup and Delivery Photo Validation", type: "Service design", image: "/project-covers/pickup-delivery-validation.png", className: "project-photo-validation" },
  { title: "L3 Design Agentic Loop", type: "AI design operations", image: "/project-covers/l3-design-agentic-loop.png", className: "project-agentic" },
];

const roles = [
  { company: "Grab Singapore", role: "Product Design Lead", date: "May 2024 — Today", mark: "/profile-assets/grab.png" },
  { company: "Gojek", role: "Design Manager", date: "April 2023 — April 2024", mark: "/profile-assets/gojek.png" },
  { company: "Gojek", role: "Senior Product Designer", date: "May 2018 — April 2023", mark: "/profile-assets/gojek.png" },
  { company: "Tokopedia", role: "Product Designer", date: "2016 — 2018", mark: "/profile-assets/duolingo.png" },
];
  ...
  return <main className="portfolio-shell">
    <aside className="profile-rail" aria-label="About Saphira Amethysta"><div className="profile-inner">
      <section className="intro-block" id="about">
        <div className="identity"><img className="avatar" src="/profile-assets/saphira-avatar.png" alt="" /><div><h1>Saphira Amethysta</h1><p>Product Designer Lead at Grab</p></div></div>
      ...
      <section className="info-section"><h2>Tools</h2><div className="tool-list"><div><img src="/profile-assets/figma.png" alt="" /><span><strong>Figma</strong>General design tool</span></div><div><img src="/profile-assets/codex.png" alt="" /><span><strong>ChatGPT and Codex</strong>AI Agent</span></div><div><img src="/profile-assets/maze.png" alt="" /><span><strong>Maze</strong>Usability testing tool</span></div></div></section>
