...
export default function WorkPage() {
  return <main className="case-study">
    <nav className="case-rail" aria-label="Case study navigation">
      <PixelLink href="/" className="case-logo"><img src="/work-assets/avatar.png" alt="Home" /></PixelLink><span />
    ...
    <section className="case-content" id="overview"><aside><PixelLink href="/" className="back-link">← Back</PixelLink></aside><article>
      <h2>In H2 2026, we introduced new type of Job Card when drivers receiving incoming booking to increase Acceptance Rate.</h2>
      <img className="case-visual" src="/work-assets/job-card-variants.png" alt="Manual, Turbo Auto-accept and Auto-accept job card variants" />
      ...
      <div className="split-notes"><div><img src="/work-assets/accept-decline.png" alt="" /><b>Marketplace health</b><span>Selective acceptance makes fulfilment less reliable for passengers.</span></div><div><img src="/work-assets/driver-jacket.png" alt="" /><b>Driver confidence</b><span>Drivers need enough information and control to make safe decisions.</span></div></div>
      ...
      <div className="markets"><span>🇵🇭 Entire auto-accept as the single acceptance mode</span><span>🇲🇾 Re-allowing Manual negatively impacts auto-accept</span><span>🇸🇬 Re-allowing Manual negatively impacts auto-accept</span></div>
      ...
      <section id="design"><p className="section-kicker">Initial design</p><h3>Design principle</h3><p>Drivers need enough information and control to make safe, informed decisions, especially while driving. However, Manual Accept makes it easier to cherry-pick jobs, which harms fulfilment and marketplace health. The challenge was to introduce automatic acceptance without making drivers feel that control had been removed unfairly.</p><ul>{principles.map((principle) => <li key={principle}>{principle}</li>)}</ul>
        ...
        <img className="wide-visual" src="/work-assets/expand-collapse.png" alt="Expanded and collapsed Default Accept job cards" />
        <img className="wide-visual" src="/work-assets/current-changes.png" alt="Current and changed Default Accept experience" />
      </section>
      <section id="research"><p className="section-kicker">Design</p><img className="wide-visual" src="/work-assets/platforms.png" alt="Default Accept on Android and iOS" /><p className="section-kicker">Research</p><h3>Objective</h3><p>Evaluate how drivers interpret and react to the Default Accept experience, and the implication to Turbo as the preferred driving mode. Before rollout, we need to understand whether drivers see Turbo as clearly more valuable than DA, understand what actions trigger penalties, and feel that the downgrade experience is fair but meaningful.</p>
        <div className="research-signals"><div><img src="/work-assets/ear.png" alt="" /><b>Usability</b><span>Drivers understand auto-accept behaviour, meaningful trip information, and consequences.</span></div><div><img src="/work-assets/charger.png" alt="" /><b>Success signals</b><span>Drivers can distinguish Turbo benefits from Default Accept limitations.</span></div></div>
      </section>
    </article></section>
  </main>;
}
